...
func main() {
	...
	fakeConn.SetData([]byte{0x68, 0x0D, 0x00, 0x01, 0x7F, 0xFF, 0xFF, 0xFF, 0x80, 0x00, 0x00, 0x00, 0x12, 0x34, 0x12, 0x34, 0x01, 0x1a, 0x40})
	fakeConn.SetData([]byte{0x68, 0x04, 0x00, 0x02, 0x12, 0x34, 0x56, 0x78, 0x02, 0xef})
